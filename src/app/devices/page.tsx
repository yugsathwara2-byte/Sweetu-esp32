        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="surface rounded-2xl p-6 w-full max-w-md animate-fade-up">
            ...
            <div className="space-y-3">
              ...
              {form.type === 'wled' && (
                <input value={form.wledIp || ''} onChange={(e) => setForm({ ...form, wledIp: e.target.value })} placeholder="WLED IP (optional, e.g. 192.168.1.50)" className="input-field w-full px-3 py-2 rounded-xl text-sm" />
              )}
